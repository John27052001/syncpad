...
.shadow-\[0_1px_0_rgba\(255\2c 255\2c 255\2c 0\.04\)\] {
  --tw-shadow: 0 1px 0 rgba(255,255,255,0.04);
...
:root {
  /* Dark theme */
  --surface: 222 18% 10%;
  --surface-hover: 222 18% 14%;
  --surface-border: 222 12% 22%;
  --accent: 270 80% 55%;
  --muted: 220 10% 46%;
  --foreground: 0 0% 98%;
  --foreground-muted: 220 10% 65%;
}

[data-theme='light'] {
  --surface: 0 0% 99%;
  --surface-hover: 220 18% 96%;
  --surface-border: 220 16% 88%;
  --accent: 270 75% 46%;
  --muted: 220 10% 46%;
  --foreground: 222 18% 12%;
  --foreground-muted: 222 10% 40%;
}
...
body {
  ...
  -moz-osx-font-smoothing: grayscale;
  background:
    radial-gradient(1200px 700px at 15% 0%, hsl(var(--accent) / 0.18), transparent 60%),
    radial-gradient(900px 600px at 85% 10%, hsl(200 80% 55% / 0.10), transparent 55%),
    hsl(var(--surface));
}
...
.editor-content::-moz-placeholder {
  color: hsl(var(--foreground-muted));
}
...
.focus-visible\:ring-offset-\[hsl\(var\(--surface\)\)\]:focus-visible {
